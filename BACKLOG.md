...
Tablero Trello: https://trello.com/invite/b/69a391a0ee00db77afb1a978/ATTI94a7cd52d7811265a4cf35622d296ed5435DD393/reservar-cancha
...
- Si no hay coincidencias, el sistema debe retornar una lista vacía con el mensaje "No se encontraron canchas".
...
- **Criterio 1 (Reserva exitosa):**
  ...
  - **Then** el sistema registra la reserva con estado "CONFIRMADA", genera un código único y retorna `201 Created` con el total calculado.
...
- Debe permitir filtrar por días anteriores o futuros mediante el parámetro `fecha`.
...
- Al marcar como FINALIZADA, la reserva pasa al historial.
